...
public class Data {
    public static List<Bier> getData(){
        ...
        bieren.add(new Bier("Bolleke",Gisting.HOGE, LocalDate.of(1833,1,1),5.2,23,false));
        ...
        bieren.add(new Bier("La Chouffe",Gisting.HOGE, LocalDate.of(1982 ,1,1),8,0,false));
        ...
        bieren.add(new Bier("Cornet",Gisting.HOGE, LocalDate.of(2014 ,8,26),8.5,25,false));
